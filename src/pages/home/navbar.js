          ...
          <div id="logoAndNav" className="container-fluid py-xl-4">
            <nav className="js-mega-menu navbar navbar-expand-xl u-header__navbar u-header__navbar--no-space my-1">
              ...
              >
                ...
                <span className="u-header__navbar-brand-text">MyYacht</span>
              </a>
              ...
              <button
                type="button"
                className="navbar-toggler btn u-hamburger u-hamburger--primary order-2 ml-2"
              ...
              >
                <ul className="navbar-nav u-header__navbar-nav">
                  <li
                    className="nav-item hs-has-sub-menu u-header__nav-item ml-4"
                    data-event="hover"
                  ...
                  <li
                    className="nav-item hs-has-sub-menu u-header__nav-item ml-2"
                    data-event="hover"
                    data-animation-in="slideInUp"
                    data-animation-out="fadeOut"
                  >
                  ...
                  {/* <li className="nav-item hs-has-sub-menu u-header__nav-item ml-4" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
                                    <a id="yachtMenu" className="nav-link u-header__nav-link u-header__nav-link-toggle u-header__nav-link-border" href="javascript:;" aria-haspopup="true" aria-expanded="false" aria-labelledby="yachtSubMenu">Yacht</a>
...
<ul
  ...
  style={{ minWidth: '230px' }} // Note the double curly braces here
>
  {/* Your list items here */}

                  {/* <li><Link to="/booking">Booking</Link></li>
                                        <li> <Link to="/Contact">contact</Link></li>
                                        <li><a className="nav-link u-header__sub-menu-nav-link" href="../yacht/yacht-single-v1.html">Yacht Single v1</a></li>
                                        <li><a className="nav-link u-header__sub-menu-nav-link" href="../yacht/yacht-single-v2.html">Yacht Single v2</a></li>
                                        <li><a className="nav-link u-header__sub-menu-nav-link" href="../yacht/yacht-booking.html">Yacht Booking</a></li>
                                    </ul>
                            
                                </li>  */}

                  {/*                           
                                <li className="nav-item hs-has-mega-menu u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut" data-max-width="722px" data-position="right">
                                    ...
                                    <div className="hs-mega-menu u-header__sub-menu u-header__sub-menu-rounded" aria-labelledby="pagesMegaMenu">
                                        <div className="row">
                                            <div className="col-12 col-xl-4">
                                                <ul className="u-header__sub-menu-nav-group u-header__sub-menu-bordered mb-3">
                                            ...
                                            <div className="col-12 col-xl-4">
                                                <a href="../../documentation/index.html" className="btn btn-soft-primary mb-3 w-100"><span className="fas fa-laptop-code mr-2"></span>Documentation</a>
                                                <a href="../../starter/index.html" className="btn btn-soft-secondary w-100"><span className="fas fa-th mr-2"></span>Starter</a>
                                            </div>
                                        </div>
                                    </div>
